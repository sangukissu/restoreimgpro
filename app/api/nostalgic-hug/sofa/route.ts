...
export async function POST(req: NextRequest) {
    try {
        ...
        const result = await fal.subscribe("fal-ai/nano-banana-pro/edit", {
            input: {
                prompt: "Make the person sitting centered, alone on a large, deep-set, realistic-looking, vintage-style sofa (e.g., deep brown, 90s floral pattern, or heavy brocade upholstery) , with enough empty space beside them to comfortably accommodate a second person.\n  Understand the physics of body proportion in relation to the visible body part from the reference image; ensure the generated body has the relative height and size based on the reference face photo size, must not look ike cartoon body.\n  Ultra realistic but natural look with real camera imperfections slight film grain minor chromatic aberration tiny lens dust soft depth of field light vignette and imperfect highlights.\n  important: Keep the face identity and clothing from the reference image exactly consistent.",
                num_images: 1,
                aspect_ratio: "4:3",
                output_format: "png",
