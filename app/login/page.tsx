        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
          ...
          <div className="mt-6 space-y-4">
            ...
            <form action={signInWithGoogle}>
              <Button type="submit" variant="outline" className="w-full border-gray-300 hover:bg-gray-50 text-black py-3 text-base font-medium rounded-lg h-12 bg-transparent">
