      ...
      <main className="pt-32 pb-20">
        <div className="max-w-[1320px] mx-auto px-4 sm:px-8">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl lg:text-5xl font-[850] text-brand-black tracking-tight mb-6">Privacy Policy</h1>
          ...
          <div className="bg-white rounded-[2.5rem] p-8 md:p-16 shadow-sm max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none prose-headings:font-bold prose-headings:text-brand-black prose-p:text-gray-600 prose-li:text-gray-600">
              <div className="space-y-12">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-brand-black mb-4">Photo Privacy & Security</h2>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-brand-black mb-4">Data Sharing</h2>
                  <div className="text-gray-600 space-y-4">
                    <p>We do not sell, rent, or share your personal information with third parties, except:</p>
                    <ul className="list-disc pl-6 space-y-2">
                      <li>Payment processors (dodopayments) for transaction processing</li>
