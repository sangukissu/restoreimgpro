      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="max-w-3xl mx-auto text-4xl lg:text-5xl text-black mb-6 leading-tight">
            Simple & Transparent Pricing to Restore Your Past
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-4xl mx-auto mb-24">
          ...
          {/* Starter Plan */}
          <div className="bg-gray-50 rounded-3xl p-8 border-6 border-gray-200 h-full flex flex-col">
          ...
          <div className="bg-black text-white rounded-3xl p-8 border-6 border-gray-800 relative h-full flex flex-col">
