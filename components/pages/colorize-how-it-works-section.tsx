...
export default function ColorizeHowItWorksSection() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-4xl lg:text-5xl font-bold text-black">
            Here's how BringBack <Cover>works</Cover>
          </h2>
        </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 relative">
            ...
            <div className="bg-white lg:mt-8 rounded-2xl p-8 shadow-sm border-6 border-gray-200 bg-transparent backdrop-blur transform -rotate-2 sm:-rotate-5 relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed">
                Drop in your black and white photos — vintage family portraits, historical images, old wedding photos
                and all. We handle any era.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border-6 border-gray-200 bg-transparent backdrop-blur transform rotate-2 sm:rotate-5  relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed">
                In seconds, our AI analyzes the image and applies realistic colors based on historical context, skin
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border-6 border-gray-200 bg-transparent backdrop-blur transform -rotate-2 sm:-rotate-5 relative z-10">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">Get Your Colorful Memory</h3>
              <p className="text-gray-600 leading-relaxed">
                You get back a vibrant, naturally colored version that brings your vintage memories to life, ready to
                share and treasure.
              </p>
            </div>
          </div>
        ...
        <div className="text-center mt-16">
          <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
            No art skills needed, no manual color picking. Just upload your black and white photo and watch decades of
            history come alive in color.
          </p>
        </div>
      </div>
    </section>
