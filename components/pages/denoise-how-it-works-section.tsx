      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 relative">
            ...
            <div className="bg-white lg:mt-8 rounded-2xl p-8 shadow-sm border-6 border-gray-200 bg-transparent backdrop-blur transform -rotate-2 sm:-rotate-5 relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed">
                Drop in your grainy photos — low-light shots, high-ISO images, old digital pics and all. We handle any
                kind of noise.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border-6 border-gray-200 bg-transparent backdrop-blur transform rotate-2 sm:rotate-5  relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed">
                In seconds, our AI intelligently removes grain and color noise while preserving critical details,
                textures, and sharpness.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border-6 border-gray-200 bg-transparent backdrop-blur transform -rotate-2 sm:-rotate-5 relative z-10">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">Get Your Clean Image</h3>
              <p className="text-gray-600 leading-relaxed">
                You get back a version that looks smooth, crisp, and professional, ready to print, post, or admire.
              </p>
            </div>
          </div>
        ...
        <div className="text-center mt-16">
          <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
            No complicated plugins, no technical jargon. Just upload your grainy photo and watch the noise melt away in
            seconds.
          </p>
        </div>
      </div>
