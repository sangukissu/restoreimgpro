      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="max-w-3xl mx-auto text-4xl lg:text-5xl text-black leading-tight mb-6">
            Create Your Living Memory in 3 Simple Steps
          </h2>
 <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
There's no software to install or complicated settings to learn. Simply upload your photo, choose a style, and our AI does the rest. Your beautiful, animated memory will be ready in about a minute.
          </p>  
                  </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 relative">
            ...
            <div className="bg-white lg:mt-8 rounded-2xl p-8 shadow-sm border-6 border-gray-200 bg-transparent backdrop-blur transform -rotate-2 sm:-rotate-5 relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed">
                Start with any portrait. For the best results, we recommend using a photo that has already been restored to clarity with our restoration tool.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border-6 border-gray-200 bg-transparent backdrop-blur transform rotate-2 sm:rotate-5  relative z-10">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">Choose an Animation Style</h3>
              <p className="text-gray-600 leading-relaxed">
                Select the perfect motion from our library of beautiful, lifelike animations. From a gentle smile to a warm gaze, find the style that best fits their personality.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border-6 border-gray-200 bg-transparent backdrop-blur transform -rotate-2 sm:-rotate-5 relative z-10">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">Download & Share Your Video</h3>
              <p className="text-gray-600 leading-relaxed">
                In under 60 seconds, your animated photo will be ready. Download the high-resolution MP4 video to share with family and cherish forever.
              </p>
