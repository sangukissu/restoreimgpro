    ...
    const securityHeaders = [
      ...
      // Content Security Policy to prevent XSS attacks
      {
        ...
        value: [
          ...
          "font-src 'self' data:",
          "connect-src 'self' https://api.supabase.co https://*.supabase.co wss://*.supabase.co https://fal.ai https://*.fal.ai https://*.fal.media wss://*.fal.ai https://dodopayments.com https://*.dodopayments.com https://www.google-analytics.com https://www.googletagmanager.com https://region1.google-analytics.com https://challenges.cloudflare.com https://*.cloudflare.com",
